...
// Glyph transform inside the 0-100 grid: centred at (50,50), un-tilted, 0.54×.
...
export function drawCompassMark(ctx: CanvasRenderingContext2D, cx: number, cy: number, size: number) {
  ...
  for (const a of [45, 135, 225, 315]) {
    point(a, () => poly([[50, 15.1], [55, 50], [50, 52.5], [45, 50]], C.sand))
  }
  for (const a of [90, 180, 270]) {
    point(a, () => {
      poly([[50, 6], [56.6, 50], [50, 50]], C.ink)
      poly([[50, 6], [43.4, 50], [50, 50]], C.inkShade)
    })
  }
  poly([[50, 6], [56.6, 50], [50, 50]], C.orange)
  poly([[50, 6], [43.4, 50], [50, 50]], C.orangeShade)

  ctx.beginPath()
  ctx.arc(50, 50, 14.9, 0, Math.PI * 2)

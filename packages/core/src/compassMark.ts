...
// Glyph transform inside the 0-100 grid: centred at (50,50), un-tilted, 0.48×.
 ...
 * Long points N/E/S/W, short diagonals, two hairline rings, orange medallion
...
export function drawCompassMark(ctx: CanvasRenderingContext2D, cx: number, cy: number, size: number) {
  ...
  for (const a of [45, 135, 225, 315]) {
    point(a, () => poly([[50, 19], [54.4, 50], [50, 52.2], [45.6, 50]], C.sand))
  }
  for (const a of [90, 180, 270]) {
    point(a, () => {
      poly([[50, 10.9], [55.9, 50], [50, 50]], C.ink)
      poly([[50, 10.9], [44.1, 50], [50, 50]], C.inkShade)
    })
  }
  poly([[50, 10.9], [55.9, 50], [50, 50]], C.orange)
  poly([[50, 10.9], [44.1, 50], [50, 50]], C.orangeShade)

  ctx.beginPath()
  ctx.arc(50, 50, 13.2, 0, Math.PI * 2)
